...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('poultry_batches', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('poultry_batches', 'pen_mortality')) {
                $table->decimal('pen_mortality', 10, 3)->default(0)->after('historical_mortality');
            }
            if (!Schema::hasColumn('poultry_batches', 'mortality_rate')) {
                $table->decimal('mortality_rate', 10, 2)->default(0)->after('pen_mortality');
            }
        });
    }
    ...
    public function down(): void
    {
        Schema::table('poultry_batches', function (Blueprint $table) {
            $columns = [
                ...
                'historical_mortality', 'pen_mortality', 'mortality_rate'
            ];
