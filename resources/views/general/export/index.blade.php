...
<div class="md:flex md:items-center md:justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-600">Choose a report template and export the data your team needs.</p>
    </div>
</div>
@endsection
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <form method="POST" action="{{ route('export.run') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="export_type" id="exportType" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                        ...
                        <option value="database" selected>Full Database</option>
                ...
                <div>
                    ...
                    <select name="report_template" id="reportTemplate" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
    ...
    <div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-6">
            ...
            <div class="space-y-4">
                <form method="POST" action="{{ route('export.run') }}">
                    @csrf
                    <input type="hidden" name="export_type" value="database">
                    <input type="hidden" name="report_template" value="farm-overview">
                    <input type="hidden" name="format" value="excel">
                    <input type="hidden" name="quick" value="all_batches">
                    <button type="submit" class="w-full text-left p-4 bg-primary-50 hover:bg-primary-100 rounded-xl border border-primary-200 transition-all">
                        <div class="flex items-center">
                ...
                <form method="POST" action="{{ route('export.run') }}">
                    @csrf
                    <input type="hidden" name="export_type" value="database">
                    <input type="hidden" name="report_template" value="monthly-operations">
                    <input type="hidden" name="format" value="excel">
                    <input type="hidden" name="quick" value="current_month">
                    <button type="submit" class="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-xl border border-green-200 transition-all">
                        <div class="flex items-center">
                ...
                <form method="POST" action="{{ route('export.run') }}">
                    ...
                    <input type="hidden" name="report_template" value="performance">
                    <input type="hidden" name="format" value="excel">
                    <input type="hidden" name="quick" value="performance">
                    <button type="submit" class="w-full text-left p-4 bg-purple-50 hover:bg-purple-100 rounded-xl border border-purple-200 transition-all">
                        <div class="flex items-center">
                ...
                <form method="POST" action="{{ route('export.run') }}">
                    @csrf
                    <input type="hidden" name="export_type" value="financial">
                    <input type="hidden" name="report_template" value="financial-summary">
                    <input type="hidden" name="format" value="excel">
                    <input type="hidden" name="quick" value="financial">
                    <button type="submit" class="w-full text-left p-4 bg-yellow-50 hover:bg-yellow-100 rounded-xl border border-yellow-200 transition-all">
                        <div class="flex items-center">
                ...
                <form method="POST" action="{{ route('export.run') }}">
                    @csrf
                    <input type="hidden" name="export_type" value="database">
                    <input type="hidden" name="report_template" value="inventory-summary">
                    <input type="hidden" name="format" value="excel">
                    <input type="hidden" name="quick" value="inventory">
                    <button type="submit" class="w-full text-left p-4 bg-red-50 hover:bg-red-100 rounded-xl border border-red-200 transition-all">
                        <div class="flex items-center">
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-xl">
                ...
                <ul class="space-y-2 text-xs text-gray-600">
                    <li class="flex items-start"><i class="fas fa-check text-green-500 mt-0.5 mr-2"></i>Select a template before exporting.</li>
                    <li class="flex items-start"><i class="fas fa-check text-green-500 mt-0.5 mr-2"></i>Batch-specific exports require a valid batch.</li>
                    <li class="flex items-start"><i class="fas fa-check text-green-500 mt-0.5 mr-2"></i>Data is generated in the selected format immediately.</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleExportType() {
        batchSelection.style.display = exportType.value === 'batch' ? 'block' : 'none';
    }

    exportType.addEventListener('change', handleExportType);
    handleExportType();
});
</script>
@endpush
