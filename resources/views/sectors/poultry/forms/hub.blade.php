...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Inventory Waste -->
            <a href="{{ route('poultry.forms.inventory-waste.create') }}" class="group relative bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 rounded-lg bg-amber-100 flex items-center justify-center"><span class="text-2xl">🗑️</span></div>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-800">Audit</span>
                    </div>
                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Inventory Waste</h4>
                    <p class="text-sm text-gray-600 mb-4">Record spoilage, damage, loss, or expired items with notes</p>
                    <div class="flex items-center text-sm text-amber-600"><span>Log waste</span><i class="fas fa-arrow-right ml-2 transform group-hover:translate-x-1 transition-transform"></i></div>
                </div>
            </a>
            ...
            <a href="{{ route('poultry.forms.batch-transfer') }}" class="group relative bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-sky-100 text-sky-800">Transfer</span>
                    </div>
                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Batch Transfer</h4>
