...
<div class="md:flex md:items-center md:justify-between mb-6">
    ...
    <div class="mt-4 flex md:mt-0 md:ml-4">
        <a href="{{ $batch ? route('poultry.batches.show', $batch) : route('poultry.batches.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
        ...
        <form method="POST" action="{{ route('poultry.forms.flock-record.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="culls" id="culls" value="{{ old('culls', 0) }}" min="0" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500">
