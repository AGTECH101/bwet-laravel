...
class BatchCalculationService
{
    ...
    /**
     * Update cached metrics WITHOUT overwriting checkpoint state fields.
     * Only derived fields: FCR, profit, selling prices, mortality rate.
     * DO NOT recalculate current_cost, current_average_cost, current_count, current_weight_kg.
     */
    public static function updateCachedMetrics(Batch $batch)
    {
        DB::transaction(function () use ($batch) {
            ...
            // Flock totals – DO NOT recalc remaining_flock or checkpoint fields
            ...
            // Recalculate mortality rate (uses cumulative total_mortality)
